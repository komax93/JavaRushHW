...
public class Solution {
    ...
    {
        private static AtomicInteger numbOfGroup = new AtomicInteger(0);
        private AtomicInteger factoryNum = new AtomicInteger(0);
        private AtomicInteger numbOfThread = new AtomicInteger(0);

        public AmigoThreadFactory()
        {
            factoryNum.set(numbOfGroup.incrementAndGet());
        }
        ...
        public Thread newThread(Runnable r)
        {
            ...
            thread.setName(thread.getThreadGroup().getName() + "-pool-" + factoryNum + "-thread-" + numbOfThread.incrementAndGet());
            return thread;
        }
    }
}
