...
public class Solution {
    ...
    public static void main(String[] args) throws InterruptedException {
        //Add your code here
        ExecutorService excecutorService = Executors.newFixedThreadPool(5);
        for(int i = 0; i < 10; i++)
        {
            excecutorService.submit(new Runnable()
            {
                @Override
                public void run()
                {
        ...
        excecutorService.awaitTermination(5, TimeUnit.SECONDS);
