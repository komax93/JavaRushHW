...
public class Solution {
    ...
    public static byte[] getNetAddress(byte[] ip, byte[] mask) {
        byte[] address = {(byte) (ip[0] & mask[0]), (byte) (ip[1] & mask[1]), (byte) (ip[2] & mask[2]), (byte) (ip[3] & mask[3])};
    ...
    public static void print(byte[] bytes) {
        ...
        {
            String value = Integer.toBinaryString((int) bytes[i] + 256);
            System.out.print(value.substring(value.length() - 8) + " ");
        }
