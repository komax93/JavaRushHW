    ...
    public static void sort(List<Stock> list) {
        Collections.sort(list, new Comparator<Stock>() {
            public int compare(Stock stock1, Stock stock2) {
                ...
                result = dFormat.format(date1).compareTo(dFormat.format(date2));
                if(result != 0)
                    return result;
                ...
                {
                    Double open = (Double) stock1.get("open");
                    Double close = (Double) stock1.get("last");
                    res1 = close - open;
                }
                else
                    res1 = (Double) stock1.get("change");

                if(stock2.containsKey("open"))
                {
                    Double open = (Double) stock2.get("open");
                    Double close = (Double) stock2.get("last");
                    res2 = close - open;
                }
                else
                    res2 = (Double) stock2.get("change");
